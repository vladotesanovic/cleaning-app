...
export class HomeComponent implements OnInit {
  ...
  setWindow() {
    this.offerService.toggleWindow(this.serviceCost);
  }

  setIroning() {
    this.offerService.toggleIroning(this.serviceCost);
  }

  setOven() {
    this.offerService.toggleOven(this.serviceCost);
  }

  setFridge() {
    this.offerService.toggleFridge(this.serviceCost);
  }
